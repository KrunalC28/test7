...
router.get('/cscenarios/:id', function (req, res, next) {
  trainer.getCScenarios(req.params.id, function (err, rows) {
    if (err) {
      res.json(err);
    }
    else {
...
router.get('/ncscenarios/:id', function (req, res, next) {
  trainer.getNCScenarios(req.params.id, function (err, rows) {
    if (err) {
      res.json(err);
    }
    else {
